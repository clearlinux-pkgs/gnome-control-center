...
Source0  : https://download.gnome.org/sources/gnome-control-center/3.32/gnome-control-center-3.32.2.tar.xz
...
%prep
%setup -q -n gnome-control-center-3.32.2
%patch1 -p1
%patch2 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1558941690
export AR=gcc-ar
