...
Source0  : https://download.gnome.org/sources/gnome-control-center/43/gnome-control-center-43.4.1.tar.xz
...
%prep
%setup -q -n gnome-control-center-43.4.1
cd %{_builddir}/gnome-control-center-43.4.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676303447
