...
Version  : 3.24.3
Release  : 9
URL      : https://download.gnome.org/sources/gnome-control-center/3.24/gnome-control-center-3.24.3.tar.xz
Source0  : https://download.gnome.org/sources/gnome-control-center/3.24/gnome-control-center-3.24.3.tar.xz
...
%prep
%setup -q -n gnome-control-center-3.24.3
%patch1 -p1
%patch2 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1500771210
