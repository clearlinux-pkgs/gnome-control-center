...
Source0  : https://download.gnome.org/sources/gnome-control-center/41/gnome-control-center-41.2.tar.xz
...
%prep
%setup -q -n gnome-control-center-41.2
cd %{_builddir}/gnome-control-center-41.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638527639
...
cp %{_builddir}/gnome-control-center-41.2/COPYING %{buildroot}/usr/share/package-licenses/gnome-control-center/13d2034b5ee3cb8d1a076370cf8f0e344a5d0855
cp %{_builddir}/gnome-control-center-41.2/panels/wacom/calibrator/COPYING %{buildroot}/usr/share/package-licenses/gnome-control-center/5dfd8a387b5dd2491e61f9649b1cec0ab059c0dd
cp %{_builddir}/gnome-control-center-41.2/subprojects/libhandy/COPYING %{buildroot}/usr/share/package-licenses/gnome-control-center/01a6b4bf79aca9b556822601186afab86e8c4fbf
