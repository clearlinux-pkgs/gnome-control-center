...
Version  : 46.0
Release  : 100
URL      : https://download.gnome.org/sources/gnome-control-center/46/gnome-control-center-46.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-control-center/46/gnome-control-center-46.0.tar.xz
...
%prep
%setup -q -n gnome-control-center-46.0
cd %{_builddir}/gnome-control-center-46.0
%patch -P 1 -p1
pushd ..
cp -a gnome-control-center-46.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710946708
