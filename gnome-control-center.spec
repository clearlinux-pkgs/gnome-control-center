...
Source0  : https://download.gnome.org/sources/gnome-control-center/3.24/gnome-control-center-3.24.0.tar.xz
...
%prep
%setup -q -n gnome-control-center-3.24.0
%patch1 -p1

%build
export LANG=C
export SOURCE_DATE_EPOCH=1491760170
