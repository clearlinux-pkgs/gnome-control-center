...
Version  : 3.24.2
Release  : 8
URL      : https://download.gnome.org/sources/gnome-control-center/3.24/gnome-control-center-3.24.2.tar.xz
Source0  : https://download.gnome.org/sources/gnome-control-center/3.24/gnome-control-center-3.24.2.tar.xz
...
%prep
%setup -q -n gnome-control-center-3.24.2
%patch1 -p1
%patch2 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1494553163
