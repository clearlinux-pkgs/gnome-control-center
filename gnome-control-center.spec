...
Version  : 41.0
Release  : 60
URL      : https://download.gnome.org/sources/gnome-control-center/41/gnome-control-center-41.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-control-center/41/gnome-control-center-41.0.tar.xz
...
%prep
%setup -q -n gnome-control-center-41.0
cd %{_builddir}/gnome-control-center-41.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632494402
...
cp %{_builddir}/gnome-control-center-41.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-control-center/13d2034b5ee3cb8d1a076370cf8f0e344a5d0855
cp %{_builddir}/gnome-control-center-41.0/panels/wacom/calibrator/COPYING %{buildroot}/usr/share/package-licenses/gnome-control-center/5dfd8a387b5dd2491e61f9649b1cec0ab059c0dd
cp %{_builddir}/gnome-control-center-41.0/subprojects/libhandy/COPYING %{buildroot}/usr/share/package-licenses/gnome-control-center/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/gnome-control-center-41.0/subprojects/libhandy/debian/copyright %{buildroot}/usr/share/package-licenses/gnome-control-center/4edf9bbb2cfc4d22f89ac2a08f41edd324a68320
