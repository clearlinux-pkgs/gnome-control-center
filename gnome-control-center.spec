...
Source0  : https://download.gnome.org/sources/gnome-control-center/3.28/gnome-control-center-3.28.0.tar.xz
...
%prep
%setup -q -n gnome-control-center-3.28.0
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1522204782
