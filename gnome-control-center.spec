...
Source0  : https://download.gnome.org/sources/gnome-control-center/46/gnome-control-center-46.4.tar.xz
...
%prep
%setup -q -n gnome-control-center-46.4
cd %{_builddir}/gnome-control-center-46.4
%patch -P 1 -p1
pushd ..
cp -a gnome-control-center-46.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722867918
