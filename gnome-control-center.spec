...
Source0  : https://download.gnome.org/sources/gnome-control-center/3.30/gnome-control-center-3.30.3.tar.xz
...
%prep
%setup -q -n gnome-control-center-3.30.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1552434356
