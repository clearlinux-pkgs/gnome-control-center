...
Version  : 42.1
Release  : 65
URL      : https://download.gnome.org/sources/gnome-control-center/42/gnome-control-center-42.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-control-center/42/gnome-control-center-42.1.tar.xz
...
%prep
%setup -q -n gnome-control-center-42.1
cd %{_builddir}/gnome-control-center-42.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650999133
...
cp %{_builddir}/gnome-control-center-42.1/COPYING %{buildroot}/usr/share/package-licenses/gnome-control-center/13d2034b5ee3cb8d1a076370cf8f0e344a5d0855
cp %{_builddir}/gnome-control-center-42.1/panels/wacom/calibrator/COPYING %{buildroot}/usr/share/package-licenses/gnome-control-center/5dfd8a387b5dd2491e61f9649b1cec0ab059c0dd
