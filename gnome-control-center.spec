...
Version  : 3.30.2
Release  : 30
URL      : https://download.gnome.org/sources/gnome-control-center/3.30/gnome-control-center-3.30.2.tar.xz
Source0  : https://download.gnome.org/sources/gnome-control-center/3.30/gnome-control-center-3.30.2.tar.xz
...
%prep
%setup -q -n gnome-control-center-3.30.2
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1542072235
